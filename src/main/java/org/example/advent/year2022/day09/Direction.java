...
public enum Direction {
    ...
    public static Map<Coordinate, Direction> DIRECTION_MAP = Map.of(
            new Coordinate(1L, 0L), U,
            new Coordinate(-1L, 0L), D,
            new Coordinate(0L, -1L), L,
            new Coordinate(0L, 1L), R,
            new Coordinate(1L, 1L), UR,
            new Coordinate(1L, -1L), UL,
            new Coordinate(-1L, 1L), DR,
            new Coordinate(-1L, -1L), DL
    );
}
