...
public class MapHistory {
    ...
    private static final String INPUT_PATH = "adventOfCode/2023/day9/input.txt";
    private static final String SAMPLE_INPUT_PATH = "adventOfCode/2023/day9/input-sample.txt";
