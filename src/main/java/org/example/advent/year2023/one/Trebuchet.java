...
public class Trebuchet {
    private static final String INPUT_PATH = "adventOfCode/2023/day1/input.txt";
    private static final String SAMPLE_INPUT_PATH = "adventOfCode/2023/day1/input2.txt";
